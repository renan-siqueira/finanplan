...
export class InMemoryDataBase implements InMemoryDbService {
    createDb() {
        ...
        const entries: Entry[] = [
            ...
            { id: 4, name: 'Salário empresa X', categoryId: categories[3].id, category: categories[3], paid: false, date: '17/10/2021', amount: '12.500,00', type: 'revenue', description: 'Salário mensal' } as Entry,
            ...
            { id: 6, name: 'Salário empresa Y', categoryId: categories[3].id, category: categories[3], paid: false, date: '19/10/2021', amount: '9.000,00', type: 'revenue', description: 'Salário mensal' } as Entry,
            ...
            { id: 9, name: 'Aluguel', categoryId: categories[0].id, category: categories[0], paid: false, date: '22/10/2021', amount: '2.760,00', type: 'expense', description: 'Aluguel do apartamento' } as Entry,
